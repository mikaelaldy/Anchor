...
export default function KineticPlayer({ active, mood, duration, onComplete, onBack }: Props) {
  ...
  const ringSize   = isMobile ? Math.min(window.innerWidth * 0.85, 360) : 400;
  ...
  const nodeSize = isMobile ? Math.min(window.innerWidth * 0.52, 220) : 260;
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        padding: isMobile ? "20px 24px 16px" : "28px 32px 20px",
      }}>
        <button
          onClick={onBack}
          style={{
      ...
      <div
        style={{
          ...
          transform: nodeVisible ? "scale(1)" : "scale(1.1)",
